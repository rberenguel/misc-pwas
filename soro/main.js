            ...
            const LESSONS = [
                {
                    ...
                    description: "To represent a number, move beads towards the center reckoning bar. Each bead in the top 'heaven' deck is worth 5, and each in the bottom 'earth' deck is worth 1. For example, to make the number 7 on a rod, you move down one heaven bead (5) and move up two earth beads (2).",
                    generateProblem: generateRepresentationProblem,
                },
                {
                    title: "2. Simple Addition",
                    description: "Set the first number on the soroban, starting from the right. To add the second number, simply move the corresponding beads towards the reckoning bar for each digit. For example, to add 2 to 5, you move two earth beads up on the rod that shows 5.",
                    generateProblem: generateSimpleAdditionProblem,
                },
                {
                    title: "3. Simple Subtraction",
                    description: "Set the first number on the soroban. To subtract, move beads away from the reckoning bar. For example, to subtract 3 from 8, you would move three earth beads down.",
                    generateProblem: generateSimpleSubtractionProblem,
                },
                {
                    title: "4. Addition with Carrying",
                    description: "When a rod's value exceeds 9, you must 'carry over'. For example, to add 8 to 6: start with 6 on a rod. To add 8, you can use a 10's complement: add 1 to the next rod on the left (add 10) and subtract 2 from the current rod. The result is 14.",
                    generateProblem: generateAdditionWithCarryingProblem,
                },
                {
                    title: "5. Subtraction with Borrowing",
                    description: "If you need to subtract a larger digit from a smaller one on a rod, you 'borrow' from the left. For example, to subtract 9 from 14: start with 14. On the units rod (4), you need to subtract 9. Borrow 1 from the tens rod (making it 0), then subtract 9 from 14 on the units rod by using a 10's complement: subtract 10 (by borrowing) and add 1. The result is 5.",
                    generateProblem: generateSubtractionWithBorrowingProblem,
                },
                {
                    title: "6. Introduction to Multiplication",
                    description: "Set the multiplicand (e.g., 54) on the right side of the soroban and the multiplier (e.g., 3) on the left. Multiply the first digit of the multiplicand (5) by the multiplier (3) to get 15. Place this result in the rods immediately to the left of the multiplicand. Then, multiply the next digit (4) by the multiplier (3) to get 12 and add it to the previous result, shifted one rod to the right. The final answer is 162.",
                    generateProblem: generateSingleDigitMultiplicationProblem,
                },
                {
                    title: "7. Multi-Digit Multiplication",
                    description: "This extends the same principle. Multiply each digit of the multiplicand by each digit of the multiplier, carefully placing the partial products in the correct rods. For example, for 23 * 14, first multiply 23 by 4 to get 92. Then multiply 23 by 10 to get 230. Add these results (92 + 230) on the soroban to get 322.",
                    generateProblem: generateMultiDigitMultiplicationProblem,
                },
                {
                    title: "8. Basic Division",
                    description: "Set the dividend on the right and the divisor on the left. For 84 / 4: ask how many times 4 goes into 8. The answer is 2. Place 2 on a rod to the left of the dividend. Subtract 4 * 2 = 8 from the dividend. Now, see how many times 4 goes into the remaining 4. The answer is 1. Place 1 next to the 2. The result is 21.",
                    generateProblem: generateSingleDigitDivisionProblem,
                },
                {
                    title: "9. Long Division",
                    description: "Similar to basic division, but involves more steps of estimation, multiplication, and subtraction, especially with multi-digit divisors. For 276 / 12: How many times does 12 go into 27? Two times. Place 2 as the first digit of the quotient. Subtract 12 * 2 = 24 from 27, leaving 3. Bring down the 6 to make 36. How many times does 12 go into 36? Three times. Place 3 as the next digit of the quotient. The result is 23.",
                    generateProblem: generateMultiDigitDivisionProblem,
                },
                {
                    title: "10. Combined Operations",
                    description: "Perform operations in sequence. For 15 + 21 - 8: first set 15. Then add 21 to get 36. From this result, subtract 8 to get the final answer, 28. Keep track of the intermediate results on the soroban.",
                    generateProblem: generateCombinedOperationsProblem,
                },
                {
                    title: "11. Introduction to Decimals",
                    description: "Designate a specific rod as the units rod (where the decimal point is). Rods to the right represent tenths, hundredths, and so on. Then, perform operations as usual, being mindful of the decimal point's location. For 1.5 + 2.3, set 1 on the units rod and 5 on the tenths rod. Then add 2 to the units and 3 to the tenths to get 3.8.",
                    generateProblem: generateDecimalsProblem,
                },
                {
                    title: "12. All Operations Challenge",
                    description: "This is a test of your soroban mastery. Apply all the techniques you've learned—addition, subtraction, multiplication, and division—to solve complex, multi-step problems. Pay close attention to the order of operations.",
