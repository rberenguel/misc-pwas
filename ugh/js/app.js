...
import { startWorkout, pauseWorkout, resumeWorkout, cancelWorkout, finishWorkout } from './workout.js';
...
function initEventListeners() {
    ...
    document.getElementById('btn-close-history').addEventListener('click', (e) => {
        e.stopPropagation();
    ...
    document.addEventListener('visibilitychange', () => {
        if (document.visibilityState === 'visible' && state.current === STATE.RUNNING) {
            toggleWakeLock(true);
        }
    });
}
