...
- **Drag & Drop:** Create new cards by dragging (ideally chat) URLs onto the add button. Update a card's primary link by dragging a new URL onto it.
...
- **Developer Workflow:**
  - Link cards to local project folders to open them directly in VS Code with the folder icon.
  - Add a GitHub link by dragging a GitHub URL into a card.
